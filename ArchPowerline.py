...
if choice == '1' or choice == '4':
    with open(home + '/.zshrc', 'a') as zshrc:
        zshrc.write('''\nif [[ -r /usr/lib/python''' + python_version + '''/site-packages/powerline/bindings/zsh/powerline.zsh ]]; then
    source /usr/lib/python''' + python_version + '''/site-packages/powerline/bindings/zsh/powerline.zsh
fi\n''')
        zshrc.close()

if choice == '2' or choice == '4':
    with open(home + '/.bashrc', 'a') as bashrc:
        bashrc.write('''\nif [[ -r /usr/lib/python''' + python_version + '''/site-packages/powerline/bindings/bash/powerline.sh ]]; then
    source /usr/lib/python''' + python_version + '''/site-packages/powerline/bindings/bash/powerline.sh
fi\n''')
        bashrc.close()

if choice == '3' or choice == '4':
    with open(home + '/.vimrc', 'a') as vimrc:
        vimrc.write('''\nset rtp+=/usr/lib/python''' + python_version + '''/site-packages/powerline/bindings/vim/
set laststatus=2
